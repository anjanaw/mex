...
results_file = '/home/mex/results_lopo/3m/act_dc_pm.csv'
...
def build_early_fusion():
    ...
    input_tdcpm = concatenate([input_t, input_dc, input_pm], axis=2)

    x = TimeDistributed(Conv1D(32, kernel_size=5, activation='relu'))(input_tdcpm)
    ...
    model = Model(inputs=[input_t, input_dc, input_pm], outputs=x)
    model.summary()
    return model
